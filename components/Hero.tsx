  ...
  return (
    <section className="relative w-full h-screen min-h-[700px] overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6">
        ...
        >
          <span className="font-[family-name:var(--font-oswald)] text-sm tracking-widest uppercase text-white/50">
            Dein direkter Kontakt zum Team
          </span>
          <a
            href="tel:+4920131957501"
            className="flex items-center gap-2 font-[family-name:var(--font-inter)] text-white hover:text-[#F5C800] transition-colors text-base font-medium"
          >
          ...
          <a
            ...
            className="flex items-center gap-2 font-[family-name:var(--font-inter)] text-white hover:text-[#25D366] transition-colors text-base font-medium"
          >
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
