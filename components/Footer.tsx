          ...
          <ul className="flex flex-col items-center gap-4">
            <li>
              <a
                ...
                className="flex items-center gap-3 font-[family-name:var(--font-inter)] text-white/60 text-sm hover:text-white transition-colors group"
              >
                <span className="w-8 h-8 bg-white/5 group-hover:bg-[#CC0000] flex items-center justify-center transition-colors flex-shrink-0">
            ...
            <li>
              <a
                ...
                className="flex items-center gap-3 font-[family-name:var(--font-inter)] text-white/60 text-sm hover:text-[#25D366] transition-colors group"
              >
                <span className="w-8 h-8 bg-white/5 group-hover:bg-[#25D366] flex items-center justify-center transition-colors flex-shrink-0">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex items-center gap-6">
            {[
              ...
              <Link
                key={l.label}
                href={l.href}
                className="font-[family-name:var(--font-inter)] text-white/35 text-xs hover:text-white/80 transition-colors"
              >
                {l.label}
              </Link>
            ))}
